                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-10 mx-auto">
                                        <a type="button" class="btn btn-primary" href="tutorial2_code_block.html">View Code</a>
                                    </div>
                                </div>
                            </div>
                        </li>
                                        ...
                                        <form action="step2.php" method="POST">
                                            <div class="form-group">
                                                <div class="steps_checkbox">
                                                    <input type="checkbox" value="step2done" id="step2_checkbox" name="step2_checkbox" <?php if($step2==1 ){echo "checked";}else{echo
                                                        "";}?>/>
