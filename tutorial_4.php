...
<head>
    ...
    <title>Building the Contact Page</title>
                                        ...
                                        <form action="step4.php" method="POST">
                                            <div class="form-group">
                                                <div class="steps_checkbox">
                                                    <input type="checkbox" value="step4done" id="step4_checkbox" name="step4_checkbox" <?php if($step4==1 ){echo "checked";}else{echo
                                                        "";}?>/>
                ...
                <section id="About">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <img id="profile-pic" class="rounded mx-auto d-block" src="img/me.jpg">
                            </div>
                        </div>
                    </div>
                </section>
